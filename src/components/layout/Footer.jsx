        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-12 mb-12'>
              ...
              <ul className='space-y-3'>
                {NAV_LINKS.map((link) => (
                  <li key={link.id}>
                    ...
                    >
                      <div className='w-1.5 rounded-full bg-white/30 group-hover:bg-primary group-hover:w-2 transition-all duration-300'/>
          ...
          <FadeIn delay={200}>
            <div>
              ...
              <p className='text-white/60 text-sm mb-6 leading-relaxed'>Let's connect to do amazing things.</p>
