  ...
  return (
    <section id='services' className='relative py-20 bg-black overflow-hidden'>
        <div className='absolute inset-0 overflow-hidden'>
            ...
            <div className='absolute bottom-1/4 left-1/4 w-96 h-96 bg-primary/20 opacity-20 rounded-full blur-3xl'></div>
            <div className='absolute top-1/2 translate-x-1/2 transalte-y-1/2 w-96 h-96 bg-primary/10 opacity-20 rounded-full blur-3xl'></div>
        </div>
